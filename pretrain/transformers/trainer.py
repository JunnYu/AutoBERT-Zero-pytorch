...
class Trainer:
    ...
    def train(
        ...
        **kwargs,
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for step, inputs in enumerate(epoch_iterator):
                ...
                if (
                    ...
                    with model.no_sync():
                        lls, cor, toa = self.training_step(model, inputs)
                        tr_loss += lls
                        tr_correct_ex += cor
                        tr_total_ex += toa
                else:
                ...
                if (step + 1) % args.gradient_accumulation_steps == 0 or (
                    ...
                    #self._total_acc_scalar += float(acc)
        ...
        train_acc = round(self._total_correct_scalar / self._total_total_scalar, 4)
    ...
    def _maybe_log_save_evaluate(
        ...
        if self.control.should_log:
            ...
            tr_correct_ex_scalar = tr_correct_ex.item()
            tr_total_ex_scalar = tr_total_ex.item()
    ...
    def training_step(
        ...
        return loss.detach(), outputs["correct"].detach(), outputs["total"].detach()
